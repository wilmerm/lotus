...
class PrestamoPanelForm(PanelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        PanelForm.__init__(self, *args, **kwargs)

        # Declaración de los controles.
        self.id = wx.TextCtrl(self, style=wx.TE_READONLY, name="id")
...
class PrestamoDialogUpdate(wx.Dialog):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Controles.
        self.panel1 = PrestamoPanelForm(self)
        # Inicialización.
...
class PrestamoPanelList(wx.Panel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.button1 = wx.BitmapButton(self, wx.ID_ADD, bitmap=img.Bitmap(IMG_ADD, S64, S64), name="add")
        self.button2 = wx.BitmapButton(self, wx.ID_EDIT, bitmap=img.Bitmap(IMG_EDIT, S64, S64), name="edit")
        self.button3 = wx.BitmapButton(self, wx.ID_DELETE, bitmap=img.Bitmap(IMG_DELETE, S64, S64), name="delete")
